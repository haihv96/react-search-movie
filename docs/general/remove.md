...
To remove images optimization, delete the `images-webpack-loader` from the
[`package.json`](../../package.json), and remove the `images-loader` from [`webpack.base.babel.js`](../../internals/webpack/webpack.base.babel.js):
```
…
{
  test: /\.(jpg|png|gif)$/,
