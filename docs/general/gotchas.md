...
The webpack `html-loader` does not recognise this as an images file and will not
transfer the images to the build folder. To get webpack to transfer them, you
...
Then webpack will correctly transfer the images to the build folder.
